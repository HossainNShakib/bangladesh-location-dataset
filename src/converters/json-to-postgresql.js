...
const pgDir = path.join(basePath, 'postgresql');
...
const statements = ['-- PostgreSQL Seed Data'];
...
fs.writeFileSync(path.join(pgDir, 'seed.sql'), statements.join('\n\n'));
console.log('PostgreSQL seed file generated');